...
function PostContainer(props){
    ...
    return (
        <StyledWrapper>
            ...
            <IconS>
            <IconButton iconLink="fa-regular fa-heart" ></IconButton> <IconButton iconLink="fa-regular fa-comment-dots" text={<CommentLength postId={post.id} onClick={onButtonClick}></CommentLength>}></IconButton>
            </IconS>
            </Styledinfo>
        </StyledWrapper>
    )
