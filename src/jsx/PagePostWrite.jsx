...
function PostWritePage(props){
  ...
  return (
    ...
    <Inputarea>
      <Infoarea>
        <TextInput title="작성자" description={<UserName userId={userId} />} type="."></TextInput>
      ...
      <TextInput title="제목"  max_length='45' height="56" max_height="80" value={title} onChange={(e)=>setTitle(e.target.value)}></TextInput>
      <TextInput title="부제목" max_length='50' height="56" value={subtitle} onChange={(e)=>setSubtitle(e.target.value)}></TextInput>
